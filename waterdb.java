...
public class waterdb{
    ...
    private static String DB_NAME = "waterdb";
    private static String tablename = "water";
    static String col1="dist";
    static String col2="rain1";
    static String col3="rain2";
    static String col4="rain3";
    static String col5="rain4";
    static String col6="rain5";
