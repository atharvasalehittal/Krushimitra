...
public class graphdb{
    ...
    private static String tablename = "graph";
    static String col1="cropname";
    static String col2="year1";
    static String col3="year2";
    static String col4="year3";
    static String col5="year4";
